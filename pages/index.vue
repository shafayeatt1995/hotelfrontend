<template>
  <div>
    <section class="h-dvh bg-cover bg-center relative -mt-[81px] overflow-x-hidden">
      <div class="w-screen h-dvh absolute top-0 left-0">
        <nuxt-img loading="lazy" decoding="async" src="/hero-background.webp" alt="Hero background image Cholozai.com"
          title="Hero background image Cholozai.com" class="object-cover inset-0 w-full h-full" format="webp"
          quality="50" width="1920" height="1080" :sizes="{ xs: 640, sm: 768, md: 1024, lg: 1280, xl: 1920 }" />
      </div>
      <div class="absolute bg-gray-900/20 h-full w-full top-0 left-0"></div>
      <div class="container mx-auto relative z-10 h-full">
        <div class="flex justify-center lg:justify-between items-center h-full flex-col lg:flex-row">
          <div class="lg:w-2/3 flex flex-col justify-center px-2 md:px-0">
            <h1 class="font-black lg:text-5xl 2xl:text-7xl md:text-4xl text-2xl text-white mt-5 relative">
              Discover Every Destination in Bangladesh. A Complete Travel Guide
              <span class="font-bold">Cholozai.com</span>
            </h1>
            <p class="lg:text-xl text-sm text-white font-semibold md:mt-8 mt-4 px-2">
    ...
    <div class="container mx-auto my-5">
      <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 lg:gap-10 px-2">
      ...
      <div class="mt-10 flex items-center justify-center">
        <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm">
          ...
          <nuxt-link :to="{ name: 'all-location-page', params: { page: 1 } }" title="Next page"
