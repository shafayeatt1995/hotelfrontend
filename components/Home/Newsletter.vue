<template>
  <div class="px-2 md:px-0">
    <section
      class="container mx-auto bg-gray-100 rounded-xl overflow-hidden md:px-8 md:py-14 px-4 py-4 text-gray-800 relative"
    >
      <Dot class="absolute top-0 left-0 hidden md:block text-indigo-400" />
      <Bg class="absolute right-0 bottom-0 hidden md:block" />
      <div class="relative z-10">
        <h1 class="text-center font-bold lg:text-6xl md:text-4xl text-[26px]">
        ...
        <p class="text-center text-gray-700 md:mt-4 my-1 lg:px-0 md:px-32">
